...
function initProductPrice() {
    ...
    if (document.querySelectorAll(".shipping-price").length) {
        document
            .querySelectorAll(".shipping-price")
            .forEach(function (currentValue, index, arr) {
                var value = parseInt(currentValue.innerHTML);
                currentValue.innerHTML = formatter.format(value) + ".00";
            });
    ...
    if (document.querySelectorAll(".total-price-product").length) {
        document
            .querySelectorAll(".total-price-product")
            .forEach(function (currentValue, index, arr) {
                var value = parseInt(currentValue.innerHTML);
                currentValue.innerHTML = formatter.format(value) + ".00";
            });
    }
    if (document.querySelectorAll(".total-price").length) {
        document
